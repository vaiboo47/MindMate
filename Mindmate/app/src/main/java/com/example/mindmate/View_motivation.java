...
public class View_motivation extends AppCompatActivity {
    ListView L1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url", "") + "/stud_view_motivation";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    cont[i]=u.getString("cont");
                                    staff[i]=u.getString("staff");

                                }
                                L1.setAdapter(new custom_motivation(getApplicationContext(),id, date, title, staff, cont));//custom_view_service.xml and li is the listview object
